...
class Application_Form_Unosblogkategorije extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $this->addElement('text', 'tbNazivBlogKategorije', array(
                'label' => 'Naziv blog kategorije:',
                'required' => true,
        ...
        $naziv_kategorije = $this->getElement('tbNazivBlogKategorije');
